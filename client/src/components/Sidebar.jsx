...
function Sidebar() {
  ...
  function handleFolderChange(e) {
    ...
    if (folder.length) {
      console.log("Folder Selected:", folder[0].webkitRelativePath.split('/')[0]);
    }
  } 
  return (
    <div id="sidebar-container">
      <div id="sidebar-content">
        ...
        {dropDown && (
          <>
            ...
            <ul className="dropdown">
              <li onClick={handleCreateFolderClick}><FaFolderPlus /> Create Folder</li>
              <li>
        ...
        <div id="hmd" style={{cursor:'pointer'}}>
          <p><i className="fa-solid fa-house" style={{color: "#393b3c;"}}></i> Home</p>
        </div>
        <div id="hmd" style={{cursor:'pointer'}}>
          <p><i className="fa-brands fa-google-drive"></i> My Drive</p>
        </div>
        <div id="hmd" style={{cursor:'pointer'}}>
          <p><i className="fa-solid fa-trash" style={{color: "#0c0d0d"}}></i> Trash</p>
        </div>
      </div>
    </div>
  );

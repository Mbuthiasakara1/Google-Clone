...
function FolderCard({ folder, onFolderClick}) {
  ...
  const handleRenameFolder = async (folderId) => {
    ...
    try {
      const response = await fetch(`https://google-drive-clone-v6g6.onrender.com/api/folders/${folderId}`, {
        method: "PATCH",
  ...
  const handleFolderDownload = async () => {
    ...
    try {
      const response = await fetch(`https://google-drive-clone-v6g6.onrender.com/api/folders/${folder.id}/download`, {
        method: "GET",
        credentials: "include",
      });
  ...
  const confirmMove = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://google-drive-clone-v6g6.onrender.com/api/folders/${folder.id}/move`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
  ...
  const handleMoveToTrash = (item) => {
    ...
    fetch(`https://google-drive-clone-v6g6.onrender.com/api/folders/${folder.id}/move-to-trash`, {
      method: 'PATCH',
      headers: { "Content-Type": "application/json" },
